...
class PageController extends Controller
{
 ...
 // <-- INI BAGIAN KRUSIAL
    ...
    public function showBlog() // Atau nama method yang sesuai
    {
        // Ambil 3 post terbaru, diurutkan dari yang paling baru dibuat
        $recentBlogs = Blog::latest()->take(3)->get();

        // Kirim data posts ke view
        return view('blog', compact('recentBlogs')); // Pastikan nama view 'blog' sesuai
    }
