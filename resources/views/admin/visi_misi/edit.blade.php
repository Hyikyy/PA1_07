                ...
                <div class="card-body">
                    <form action="{{ route('admin.visi_misi.update', $visiMisi->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="visi" name="visi" rows="3" required>{{ $visiMisi->visi }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="misi" class="form-label">Misi</label>
                            <textarea class="form-control" id="misi" name="misi" rows="3" required>{{ $visiMisi->misi }}</textarea>
                        </div>
